...
df_no_moons = df_no_moons = pd.read_sql("""
    SELECT * FROM planets
...
# CodeGrade step2
# Replace None with your code
df_name_seven = df_no_moons = pd.read_sql("""
    SELECT * FROM planets
    WHERE num_of_moons = 0;
""", conn1)
df_no_moons
...
# CodeGrade step4
# Replace None with your code
df_mass_moon = df_mass_moon = pd.read_sql("""
    SELECT * FROM planets
...
# CodeGrade step6
# Replace None with your code
df_hungry = df_hungry = pd.read_sql("""
...
# CodeGrade step7
# Replace None with your code
df_hungry_ages = df_hungry_ages = pd.read_sql("""
...
# CodeGrade step8
# Replace None with your code
df_4_oldest = df_4_oldest = pd.read_sql("""
    SELECT name, age, breed FROM dogs
    ORDER BY age DESC
    LIMIT 4;
""", conn2)
# Sort alphabetically by breed after retrieval (or use subquery)
...
# CodeGrade step9
# Replace None with your code
df_ruth_years = df_ruth_years = pd.read_sql("""
...
# CodeGrade step11
# Replace None with your code
df_teams_years =df_teams_years = pd.read_sql("""
...
# CodeGrade step12
# Replace None with your code
df_at_bats = f_at_bats = pd.read_sql("""
